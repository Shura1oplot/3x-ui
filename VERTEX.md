...
--name vertex --dns 1.1.1.1 --dns 8.8.8.8 -p 0.0.0.0:80:80 -p 0.0.0.0:443:443 -p 127.0.0.1:8000:8000 -p 127.0.0.1:8123:8123 -p 0.0.0.0:8443:8443 -p 127.0.0.1:3128:3128 -p 127.0.0.1:1080:1080 -v ./cert:/root/cert -v ./conf:/etc/x-ui:rw shura1oplot/vertex:latest
